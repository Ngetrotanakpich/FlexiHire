...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-lg-3">
			...
			<div class="card mb-4">
				...
				<div class="card-body text-center">
					...
					<p class="card-text"><i class="fas fa-user"></i> <?php echo $f_user; ?></p>
		...
		<div class="col-lg-7">
			...
			<div class="card mb-4">
				<div class="card-header bg-primary text-white"><h5>Freelancer Profile Details</h5></div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item"><strong>Professional Title:</strong> <h6><?php echo $prof_title; ?></h6></li>
					<li class="list-group-item"><strong>Skills:</strong> <h6><?php echo $skills; ?></h6></li>
					<li class="list-group-item"><strong>Profile Summary:</strong> <h6><?php echo $profile_sum; ?></h6></li>
					<li class="list-group-item"><strong>Education:</strong> <h6><?php echo $education; ?></h6></li>
					<li class="list-group-item"><strong>Experience:</strong> <h6><?php echo $experience; ?></h6></li>
				</ul>
			</div>
		...
		<div class="col-lg-2">
			...
			<div class="card mb-4">
				<div class="card-header bg-info text-white"><h6>Social Network Profiles</h6></div>
				<ul class="list-group list-group-flush">
